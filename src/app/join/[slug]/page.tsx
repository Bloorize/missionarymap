...
export default function JoinEventPage() {
    ...
    // Persist submission state simply
    useEffect(() => {
        if (localStorage.getItem(`submitted_${slug}`)) {
        ...
        <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
            <Card className="max-w-md w-full shadow-xl">
                <CardHeader className="text-center pb-2">
                    ...
                    <CardDescription>Where is <span className="font-semibold">{event.youthName}</span> going?</CardDescription>
                </CardHeader>
                <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-6 pt-4">
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-medium" htmlFor="mission">Your Guess</label>
