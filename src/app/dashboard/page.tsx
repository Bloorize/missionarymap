...
import { getMyEventSlugs } from "@/lib/storage";
import { Button } from "@/components/ui/button";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import { Plus, Calendar, ArrowRight, Loader2 } from "lucide-react";

export default function DashboardPage() {
  const [events, setEvents] = useState<Awaited<ReturnType<typeof getEventsBySlugs>> | null>(null);
  ...
  useEffect(() => {
    ...
    getEventsBySlugs(slugs).then(setEvents);
  }, []);
